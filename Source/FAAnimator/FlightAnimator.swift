...
open class FlightAnimator
{
    ...
    var animationConfigurations = [String : FAAnimatableProperty]()
...
extension FlightAnimator  {
	...
	@discardableResult open func value(_ value : Any, forKeyPath key : String) -> FAAnimatableProperty {
		
		let formalValue = associatedView?.formattedNumericValue(forValue: value, forKey: key)
		
		if let formalValue = formalValue as? UIColor
        {
			animationConfigurations[key] = FAAnimatableProperty(value: formalValue.cgColor,
															  forKeyPath: key,
															  view : associatedView!,
        ...
        {
			animationConfigurations[key] = FAAnimatableProperty(value: formalValue ?? value,
															  forKeyPath: key,
															  view : associatedView!,
															  animationKey: animationKey!)
		}
	...
	@discardableResult public func alpha(_ value : CGFloat) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "opacity")
	}
	
	@discardableResult public func anchorPoint(_ value : CGPoint) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "anchorPoint")
	}
	
	@discardableResult public func backgroundColor(_ value : CGColor) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "backgroundColor")
	}
	
	@discardableResult public func bounds(_ value : CGRect) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "bounds")
	}
	
	@discardableResult public func borderColor(_ value : CGColor) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "borderColor")
	}
	
	@discardableResult public func borderWidth(_ value : CGFloat) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "borderWidth")
	}
	
	@discardableResult public func contentsRect(_ value : CGRect) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "contentsRect")
	}
	
	@discardableResult public func cornerRadius(_ value : CGFloat) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "cornerRadius")
	}
	
	@discardableResult public func opacity(_ value : CGFloat) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "opacity")
	}
	
	@discardableResult public func position(_ value : CGPoint) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "position")
	}
	
	@discardableResult public func shadowColor(_ value : CGColor) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "shadowColor")
	}
	
	@discardableResult public func shadowOffset(_ value : CGSize) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "shadowOffset")
	}
	
	@discardableResult public func shadowOpacity(_ value : CGFloat) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "shadowOpacity")
	}
	
	@discardableResult public func shadowRadius(_ value : CGFloat) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "shadowRadius")
	}
	
	@discardableResult public func size(_ value : CGSize) -> FAAnimatableProperty
    {
		return bounds(CGRect(x: 0, y: 0, width: value.width, height: value.height))
	}
	
	@discardableResult public func sublayerTransform(_ value : CATransform3D) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "sublayerTransform")
	}
	
	@discardableResult public func transform(_ value : CATransform3D) -> FAAnimatableProperty
    {
		return self.value(value, forKeyPath : "transform")
	}
	
	@discardableResult public func zPosition(_ value : CGFloat) -> FAAnimatableProperty
    {
